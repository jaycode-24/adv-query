...
import com.jaycode24.common.request.PageRequest;
import com.jaycode24.common.support.MybatisPage;
import com.jaycode24.common.support.PageSqlUtil;
...
public class PagePlugin implements Interceptor {
    ...
    private PageRequest checkPageRequest(Object parameterObject) {
        if (parameterObject instanceof PageRequest &&
                ((PageRequest) parameterObject).getPageNo() != null && ((PageRequest) parameterObject).getPageNo() > 0 &&
